                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group {{ $errors->has('captcha') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="" id="captcha" class="form-control" name="captcha">

                                <img src="{{ captcha_src('flat') }}" class="thumbnail captcha" alt="" onclick="this.src='/capcha/flat?'+Math.random()" title="点击图片重新获取验证码">
